...
(function() {
    ...
    angular
        .module('app.newTileDlg', ['ngAnimate', 'ui.bootstrap', 'ui.select', 'ngFileUpload', 'stripe.checkout', 'flash', 'ui.bootstrap.datetimepicker'])
        ...
        .controller('newTileDlgController', newTileDlgController);

    function newTileDlgController($scope, $http, $rootScope, RouteHelpers, APP_APIS, Upload, TileService, ProductService, Flash, AuthService, LookupService) {
